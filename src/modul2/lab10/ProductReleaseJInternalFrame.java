 ...
 * @author Acer
 */
public class ProductReleaseJInternalFrame extends javax.swing.JInternalFrame {
    ...
    public ProductReleaseJInternalFrame() {
        initComponents();
    ...
    private void FillTable() {
        try { 
            ResultSet resultSet;
            resultSet = StockSystem.unitOfWork.ProductReleases.GetAll();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Выгрузка товара");
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        try {
            ...
            Logger.getLogger(ProductReleaseJInternalFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        FillTable();
    ...
    try {
        ...
        productRelease.ProductId = products.get(index).Id;
        productRelease.Amount = Integer.parseInt(jTextField1.getText());

        StockSystem.unitOfWork.ProductReleases.Create(productRelease) ;
        jTextField1.setText("");
