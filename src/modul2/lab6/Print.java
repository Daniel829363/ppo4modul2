...
public class Print extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PrintJFrame s = new PrintJFrame(tableToPrint);
        s.ggg();
    s.setVisible(true);
    ...
    private void filterTableByID() {
        jTable1=tableToPrint;
        try{
            Connection conn = ConnectMsSql.ConnectDB();
            String sql = "SELECT [id],[name],[surname],[address],[email],[birth_date] FROM [view_student_info] Where id="+jTextField1.getText();
        ...
        PrintJFrame s = new PrintJFrame(jTable1);
        s.ggg();
    s.setVisible(true);
    }
